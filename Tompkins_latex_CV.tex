...
\begin{document}
\makeheading{Randy P. Tompkins, Ph.D.}
...
14235 Ballinger Terrace      & 304-780-6010 \\
Burtonsville, MD 20866       & \email{randyto@hotmail.com}\\
\end{tabular}
...
% will fill in later \section{Research Interests}
...
\item[] Ph.D.,
        \href{http://physics.wvu.edu/}
             {Physics},
             December 2009
        \begin{innerlist}
        \item Dissertation Title: \emph{Polarity Inverted Gallium Nitride for Photonic Crystal Biosensors}
        \item Advisor:
              \href{http://www.msec.txstate.edu/Contact-Us/Program-Office.html}
                   {Thomas H. Myers, Ph.D}
        \end{innerlist}
...
\item[] B.S.,
        ...
        \item \href{https://www.pbk.org/home/index.aspx}{Phi Beta Kappa}
